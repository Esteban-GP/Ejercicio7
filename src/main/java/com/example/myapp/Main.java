...
public class Main {
	...
	@Bean
	CommandLineRunner initData(EmpleadoService empleadoService, DepartamentoService departamentoService, NominaService nominaService) {
		return args -> {
			...
			Empleado jose = new Empleado(1L, "López Pérez, José", "jlp@gmail.com", marketing , 25000d, true, Genero.MASCULINO, null);
			Nomina nominaJose = new Nomina(1L, jose,  "04/04/2024", 25000d);	
			empleadoService.anadir(jose);
			nominaService.anadir(nominaJose);
			...
			empleadoService.anadir(
					new Empleado(4L, "Pérez Gómez, María", "mariapg@gmail.com", marketing, 18000d, true, Genero.FEMENINO, null));
			...
			empleadoService.anadir(new Empleado(6L, "Sánchez López, Laura", "laurasl@gmail.com", rrhh, 27000d, true,
					Genero.FEMENINO, null));
			empleadoService.anadir(
					new Empleado(7L, "Ruiz García, David", "davidruiz@gmail.com", rrhh, 19000d, false, Genero.OTROS, null));
